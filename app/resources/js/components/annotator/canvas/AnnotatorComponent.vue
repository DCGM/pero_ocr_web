    ...
    <div class="d-flex">
        ...
        <aside id="tool-bar" class="d-flex flex-column">
            ...
            <div class="p-2 text-center"
                 ...
                 @click="canvasSelectTool(polygon_tool); creating_annotation_type='rows';"><i class="fas fa-draw-polygon"></i>
            </div>
...
import {emitAnnotationEditedEvent, serializeAnnotation, getAnnotations, loadAnnotations, removeAnnotation, removeAnnotationSegm, createAnnotation, createAnnotationView, activeRegionChangedHandler, activeRowChangedHandler} from './annotations';
...
export default {
    ...
    methods: {
        ...
        emitAnnotationEditedEvent, serializeAnnotation, getAnnotations, loadAnnotations, removeAnnotation, removeAnnotationSegm, createAnnotation, createAnnotationView,
