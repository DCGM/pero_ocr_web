...
from app.db.general import get_user_documents, get_document_by_id, get_all_documents
...
def documents():
    ...
    return render_template('document/documents.html', documents=user_documents)
